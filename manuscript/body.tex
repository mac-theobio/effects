...
\jd{I don't like this as a separate item. What is the need?}
...
\end{center}
\caption{{\bf Bias correction for prediction and effect plots.} 
...
\jd{Fix the caption (maybe we should say “central, effects, predictions”). I don't think you need to repeat again about central estimates being the same.}
\jd{Add “data mean” as a horizontal line to the plots? I think data mean might be a good name, actually.
}
...
\jd{We should maybe discuss mediated effects and other stuff. We need to be much clearer about chains of causality and this example. Let's not say “somehow”}
