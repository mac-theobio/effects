...
The \proglang{R} software package \pkg{margins} \citep{lenth2018package} generates marginal effects. To illustrate the distinction between effects and marginal effects, we use the simulated data described in \nameref{S1_Appendix}. 
%
\begin{figure}
\centering
