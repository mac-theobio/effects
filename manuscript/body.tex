...
For simplicity, we consider an hypothetical simulation for three variables: predictors $x$ and $y$; and outcome variable $z$; such that
%
\begin{center}
\begin{tikzpicture}
    \node (1) at (0,0) {x};
