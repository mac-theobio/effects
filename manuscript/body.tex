...
\BC{\fix{We need the terms to talk about model center \dots}}
...
A \emph{mediated} effect is a situation in which only some of the input variables have a \emph{causal} impact on the outcome, even though all the variables are associated with the outcome. For example, psychological factors such as water taste in the relationship between household socio-economic status and improved water quality status.
