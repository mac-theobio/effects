...
\begin{itemize}
\item \textbf{Input variables}: Scientific variables underlying an inference or exploration.
...
\item \textbf{Anchor}: The value chosen for the \emph{focal predictor}. Typically chosen as the center point.
\end{itemize}
