...
```{r simple_coef, fig.cap="Coefficient plot for simple logistic model."}
## True beta
...
```{r reff_coef, fig.cap="Mixed model coefficient estimates."}
## Tidy coef estimates
...
```{r reff_vareff_wealthindex, fig.cap = "Distribution based approach over-estimates the predictions in age and wealth index."} 
# Wealth index
## varpred
