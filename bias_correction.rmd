...
## Pop. average
reff_vareff_age_pop <- varpred(reff_mod, "age", isolate=FALSE, pop.ave=TRUE, modelname = "Pop. ave")
...
```{r reff_vareff_wealthindex, fig.cap = "A comparison of population average and varpred based predictions. In the case of age, both methods seems to over-approximate the predictions."} 
# Wealth index
## varpred
reff_vareff_wealthindex <- varpred(reff_mod, "wealthindex", isolate=FALSE, modelname="varpred")

## Pop. average
reff_vareff_wealthindex_pop <- varpred(reff_mod, "wealthindex", isolate=FALSE, pop.ave=TRUE, modelname="Pop. ave")
