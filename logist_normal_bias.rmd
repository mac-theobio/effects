...
- Do everything by computing means of $g^{-1}$ applied to different values of the focal predictor and the *unconditional* distribution of non-focal parameters (I think this is what Steve is currently doing, at least in some cases, and what JD would prefer?)
