...
\fref{uniMulti} shows an example, based on simulated data with an interaction between correlated variables.
...
\fref{uniMulti} compares direct and indirect effects using univariate vs.~multivariate models
